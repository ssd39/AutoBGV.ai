...
> 📐 Open [`docs/architecture-diagram.drawio`](docs/architecture-diagram.drawio) in [draw.io](https://app.diagrams.net/) (or the VS Code Draw.io Integration extension) to view the full interactive diagram.
...
└──────────────────────────────┬──────────────────────────────────────────────────┘
          ...
          ▼                    ▼                      ▼
┌───────────────────┐ ┌───────────────────┐ ┌───────────────────┐
│ ⚙️ Workflow Svc    │ │ 🤖 Agent Svc      │ │ ✅ Verification    │
│ FastAPI :8001     │ │ FastAPI :8002     │ │ FastAPI :8003     │
│                   │ │                   │ │ (Phase 3 stub)    │
│ • Workflow CRUD   │ │ • Voice Calls     │ │ • Document OCR    │
│ • Doc Catalog 50+ │ │ • Audio Bridge    │ │ • Classification  │
│ • Session Init    │ │ • WhatsApp Collect│ │ • Criteria Eval   │
│ • Templates       │ │ • State Machine   │ │ • Pass/Fail       │
└────────┬──────────┘ └──────┬──────┬─────┘ └────────┬──────────┘
         │  session.created   │      │                │
